...
<body>
	...
	<div id="left_side">
		<img src="av_2.png" width="170" height="auto" >
		<br><br>
		<form action="" method="post">
			<table>
				<tr>
					<td>
						<input id="button" type="submit" name="search_student" value="Search Student">
					</td>
				</tr>
				<tr>
					<td>
						<input id="button" type="submit" name="edit_student" value="Edit Student">
					</td>
				</tr>
				<tr>
					<td>
						<input id="button" type="submit" name="add_new_student" value="Add New Student">
					</td>
				</tr>
				<tr>
					<td>
						<input id="button" type="submit" name="delete_student" value="Delete Student">
					</td>
				</tr>
				<tr>
					<td>
						<input id="button" type="submit" name="show teacher" value="Show Teachers">
					</td>
				</tr>
				<tr>
					<td>
						<input id="button" type="submit" name="show_payment" value="Show Payment">
					</td>
				</tr>
			</table>
		</form>
		...
		<?php
			...
			<?php
				if(isset($_POST['show_payment']))
				{
					?>
					<center>
						<h5>Student Payment records</h5>
						<table>
							<tr>
								<td id="td"><b>ID</b></td>
								<td id="td"><b>Name</b></td>
								<td id="td"><b>amount</b></td>
								<td id="td"><b>Payment Id</b></td>
					...
					while ($row = mysqli_fetch_assoc($query_run)) 
					{
						...
						<table style="border-collapse: collapse;border: 1px solid black;">
							<tr>
								...
								<td id="td"><?php echo $row['payment_id']?></td>
								<td id="td"><?php echo $row['added_on']?></td>
